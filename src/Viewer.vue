      ...
      <div class="content flex flex-center">
        <template v-if="authenticated">
          <template v-if="phase === Phase.Game && gameData && gameId">
            <div class="games w-100 h-100 flex flex-center">
...
const mainClassName = computed(() => `viewer ${theme.value} ${platform.value} container`)
    ...
    options: [
      {
        ...
        name: 'Achtung Ampel',
        description: 'Test',
        image_url: 'https://minotar.net/helm/Chrotos/100.png',
        votes: 4711
      },
      {
